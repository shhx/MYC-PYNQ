...
if { $list_projs eq "" } {
   create_project myc myc -part xc7z020clg400-2
}
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#USB Reset#CAN 1#CAN 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet\
...
\
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins ps7/SDIO1_CDN] [get_bd_pins xlconstant_0/dout]
  ...
  set_property PFM_NAME {xilinx.com:xd:myd:1.0} [get_files [current_bd_design].bd]
